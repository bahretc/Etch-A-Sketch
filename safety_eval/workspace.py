...
ROLES = {
    ...
    "fatal_slip": ("Fatal slip (.pdf)", False),
    "crash_report": ("DMV-349 crash report (.pdf)", True),
    "location_map": ("Provided location map", False),
    "field_investigation": ("Field Investigation File (.xlsx)", False),
    "crash_map": ("Study crash map (.html)", False),
    "analysis_memo": ("Analysis memo (.docx/.md)", True),
